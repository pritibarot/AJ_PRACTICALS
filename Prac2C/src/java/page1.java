...
public class page1 extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h2><a href=page2>Click here to visit page2</a></h2><br/>");
            out.println("<h2><a href=page3>Click here to visit page3</a></h2><br/>");
            out.println("<h2><a href=page4>Click here to visit page4</a></h2><br/>");
            out.println("<h2><a href=LogoutServlet>Click here to terminate</a></h2>");
            out.println("</body>");
            out.println("</html>");
        }
    }
