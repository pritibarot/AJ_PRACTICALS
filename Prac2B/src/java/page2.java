...
public class page2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1> <a href=\"page3\"> Click here to visit Page 3 </a> </h1>");
            out.println("<h1> <a href=\"page4\"> Click here to visit Page 4 </a> </h1>");
            out.println("<h1> <a href=\"page5\"> Click here to visit Page 5 </a> </h1>");
